 ...
 <div id="profileWrap" class="clearfix">
   ...
   <div id="userProfileBasic">
     <?php
       ...
       //INFO BAR
       $ProdCtrl->generateUserCountBar($product['id'],$product['slug'],'video');
       //BIG BUTTON
   ...
   <div id="rightInfoPane">
     <div class="photoFeedHead">
        <h3><?php echo $product['name'].'\'s videos'; ?></h3>
     </div>
     <div class="dropPane clearfix" data-pane="prodvideos-<?php echo $product['id']; ?>" id="start-0">
